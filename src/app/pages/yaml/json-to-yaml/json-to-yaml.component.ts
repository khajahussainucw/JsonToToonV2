...
export class JsonToYamlComponent implements AfterViewInit {
  ...
  private setupMetaTags() {
    this.title.setTitle('JSON to YAML Converter - Convert JSON to YAML Online');
    this.meta.updateTag({
      name: 'description',
      content: 'Convert JSON to YAML online with our fast and reliable JSON to YAML converter tool. Perfect for developers working with configuration files, Kubernetes, Docker, and CI/CD pipelines.'
    });
    this.meta.updateTag({
      name: 'keywords',
      content: 'json to yaml, json converter, json to yaml converter, convert json to yaml, json to yml, json to yaml online'
    });
  }
