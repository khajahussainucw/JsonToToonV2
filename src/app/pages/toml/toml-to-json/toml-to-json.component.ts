...
@Component({
  selector: 'app-toml-to-json',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './toml-to-json.component.html',
  styleUrl: './toml-to-json.component.css'
})
export class TomlToJsonComponent implements AfterViewInit {
  ...
  constructor(
    ...
    this.titleService.setTitle('TOML to JSON Converter - Convert TOML to JSON Online');
    this.metaService.updateTag({
      name: 'description',
      content: 'Convert TOML to JSON online. Free TOML to JSON converter with syntax highlighting.'
    });
  }
...
enabled = true`;
  ...
  convertToml() {
    try {
      ...
      this.aceOutputEditor.setValue(json, -1);
