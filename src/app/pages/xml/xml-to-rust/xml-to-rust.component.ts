...
@Component({
  selector: 'app-xml-to-rust',
  standalone: true,
  imports: [CommonModule, RouterModule, FormsModule],
  templateUrl: './xml-to-rust.component.html',
  styleUrl: './xml-to-rust.component.css'
})
export class XmlToRustComponent implements AfterViewInit {
  ...
  constructor(@Inject(PLATFORM_ID) private platformId: Object, private meta: Meta, private title: Title) {
    this.title.setTitle('XML to Rust Converter');
    this.meta.updateTag({ name: 'description', content: 'Convert XML to Rust structs online.' });
  }
  ...
  copyToClipboard() {
    ...
    navigator.clipboard.writeText(content).then(() => {
      this.copySuccessMessage = 'Rust code copied!';
