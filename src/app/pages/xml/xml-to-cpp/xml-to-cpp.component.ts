...
@Component({
  selector: 'app-xml-to-cpp',
  standalone: true,
  imports: [CommonModule, RouterModule, FormsModule],
  templateUrl: './xml-to-cpp.component.html',
  styleUrl: './xml-to-cpp.component.css'
})
export class XmlToCppComponent implements AfterViewInit {
  ...
  constructor(@Inject(PLATFORM_ID) private platformId: Object, private meta: Meta, private title: Title) {
    ...
    this.meta.updateTag({ name: 'description', content: 'Convert XML to C++ classes online.' });
  }
