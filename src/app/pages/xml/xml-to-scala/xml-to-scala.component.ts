...
@Component({
  selector: 'app-xml-to-scala',
  standalone: true,
  imports: [CommonModule, RouterModule, FormsModule],
  templateUrl: './xml-to-scala.component.html',
  styleUrl: './xml-to-scala.component.css'
})
export class XmlToScalaComponent implements AfterViewInit {
  ...
  constructor(@Inject(PLATFORM_ID) private platformId: Object, private meta: Meta, private title: Title) {
    this.title.setTitle('XML to Scala Converter');
    this.meta.updateTag({ name: 'description', content: 'Convert XML to Scala case classes online.' });
  }
  ...
  copyToClipboard() {
    ...
    navigator.clipboard.writeText(content).then(() => {
      this.copySuccessMessage = 'Scala code copied!';
