...
@Component({
  selector: 'app-xml-to-ruby',
  standalone: true,
  imports: [CommonModule, RouterModule, FormsModule],
  templateUrl: './xml-to-ruby.component.html',
  styleUrl: './xml-to-ruby.component.css'
})
export class XmlToRubyComponent implements AfterViewInit {
  ...
  constructor(@Inject(PLATFORM_ID) private platformId: Object, private meta: Meta, private title: Title) {
    this.title.setTitle('XML to Ruby Converter');
    this.meta.updateTag({ name: 'description', content: 'Convert XML to Ruby classes online.' });
  }
  ...
  copyToClipboard() {
    ...
    navigator.clipboard.writeText(content).then(() => {
      this.copySuccessMessage = 'Ruby code copied!';
