...
@Component({
  selector: 'app-xml-to-kotlin',
  standalone: true,
  imports: [CommonModule, RouterModule, FormsModule],
  templateUrl: './xml-to-kotlin.component.html',
  styleUrl: './xml-to-kotlin.component.css'
})
export class XmlToKotlinComponent implements AfterViewInit {
  ...
  constructor(@Inject(PLATFORM_ID) private platformId: Object, private meta: Meta, private title: Title) {
    this.title.setTitle('XML to Kotlin Converter');
    this.meta.updateTag({ name: 'description', content: 'Convert XML to Kotlin data classes online.' });
  }
  ...
  copyToClipboard() {
    ...
    navigator.clipboard.writeText(content).then(() => {
      this.copySuccessMessage = 'Kotlin code copied!';
