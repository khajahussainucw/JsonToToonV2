...
@Component({
  selector: 'app-xml-to-dart',
  standalone: true,
  imports: [CommonModule, RouterModule, FormsModule],
  templateUrl: './xml-to-dart.component.html',
  styleUrl: './xml-to-dart.component.css'
})
export class XmlToDartComponent implements AfterViewInit {
  ...
  constructor(@Inject(PLATFORM_ID) private platformId: Object, private meta: Meta, private title: Title) {
    this.title.setTitle('XML to Dart Converter');
    this.meta.updateTag({ name: 'description', content: 'Convert XML to Dart classes for Flutter online.' });
  }
  ...
  copyToClipboard() {
    ...
    navigator.clipboard.writeText(content).then(() => {
      this.copySuccessMessage = 'Dart code copied!';
